...
assert Version(mne_bids_pipeline.__version__)>= Version('1.10.0'), \
    f'must install mne-bids-pipeline>1.10.0, but {mne_bids_pipeline.__version__=}'
del Version
# %%05
# # General settings
...
# task: str = ["rest1", "rest2", "main"]  # Process all tasks by leaving empty
