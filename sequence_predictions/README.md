...
See also [FASTIMAGES-benchmark/examples](https://github.com/CIMH-Clinical-Psychology/FASTIMAGES-benchmark/tree/main/examples) for example scripts on how to use this data.
